...
# Scènes
- [x] Visite au temple mystique de la guerre
	- 3 pavillons + 1 dépendance et un dortoir
		- chaque pavillon pour une tradition:
	...
	- Quête du cœur d'émeraude
		...
		- membres du dojo:
			...
			2. **Disciple Haru**
			    - **Description** : Un jeune moine enthousiaste, plein d'énergie et d'ambition. Il a toujours rêvé de devenir un maître, mais il est encore en train d'apprendre. Son caractère joyeux contraste avec la gravité de la situation.
...
- [x] Les rats contre les pigeons et les corbeaux
	- les rats ne peuvent pas aider aujourd'hui parce qu'ils on ont gros
		- "On en est pas, on a des droits et même que plus!"
		- "On en a gros, on veut du boulot !"
		- "On grignote, mais on ne se laisse pas faire !"
		- "Ca peut plus continuer parce que c'est trop"
	- bagarre entre rats et pigeons et corbeaux
		- les pigeons ont rompu l'édit de la place Käzener et mangé des miettes de fromage sur le sol (au lieu de sur une table ou balcon)
		- les pigeons ont faim parce que les corbeaux sont en ville
		- les corbeaux sont en ville parce qu'il y a un lapin chasseur en forêt
- [ ] Etude de la pyramide
	- beaucoup de patrouilles autour
		...
		- peuvent voir un groupe d'aventuriers escortés à l'intérieur, accompagnant un noble
			...
			- situation réelle:
				- la pyramide est une ancienne citadelle d'invasion elfe, elle contient de nombreux morts vivants et des ressources magiques
					- les serviteurs de l'empereur liche veulent l'utiliser pour faire leur grand rituel et transformer tous les habitants de la région en mort-vivant
					- les serviteurs du roi-démon veulent en chasser les morts vivants et l'utiliser pour leur grand rituel pour faire venir un avatar du grand ennemi
					- les relations entre les 2 groupes se sont détériorées depuis que les PJs on fait échouer leurs efforts
- [x] Visite UPA
	- Quête de Louis Armelia: 
		- aller au Bellevue (resto chic) ![[Campagne/Lieux à visiter/Schmiedehafen#**Le Bellevue**]]
		- rencontrer un homme (bien habillé barbe sel et poivre, nommé Léon) l'aider à résoudre son problème
...
- [x] Visite Premier ministre
	- ne devrait pas être nécessaire
- [x] Visite manoir Dornbruck
	- inflitration
...
- [ ] Haru et la broche
	...
	- enquête dans n bar pour étudiant, avec des salon privés et des salles de réunion. Pas de séance aujourd'hui, mais le barman peut pointer les joueurs vers un des organisateurs
		...
		- explications
			- utilisent l'artefact pour leur rituel à venir
			- tunnel vers le cœur de la pyramide
		- 
...
```
- preparation poru visiter la perle d'or
  - reonnaissance
  - habits de luxe, n'emportent pas d'armure, uniquement arme simple
  - 50po de babioles pour offrir aux courtisanes
- perle d'or
  - Marcus controle la compagnie qui a transproté le blé maudit
  - les courtisanes sont interessées en nécromancie
  - les rats ont peur de l'endroit
  - Adelaide a été charmée
  - Narllak a volé la sacoche de Marcus
    - quelques parchemins de protections/soins (cure wound, cure wound, sanctuary, lesser restauration)
    - notes diverses: codées
    - comptes: codées
```
...
```
- anneaux magiques de MArcus: anneau de l'ego protégé, anneau de protection, anneau de resistance poisons
- indices
  - rituel 
    
  - contacts dans la noblesse
    
  - explication de la rivalité avec le culte de la lune noire
